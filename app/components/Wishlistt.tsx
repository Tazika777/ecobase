    ...
    <div className="w-full flex justify-center items-center px-6 py-4 sm:px-10 sm:py-6">
      <div className="w-full max-w-7xl">
        <div className="flex gap-[20px] ">
          ...
          <div className="w-[984px] h-[742px] rounded-[8px] border-[1px] border-slate-300 flex flex-col">
            <div className="flex flex-col p-[15px] gap-[25px] ">
              <div className="flex justify-between  w-full h-[36] border-b-2 ">
                <div className="flex gap-[15px] items-center">
                  <p className="text-xl	font-medium	">Recet Order History</p>
                  <p className="text-slate-400 text-sm ">April 24, 2021</p>
                  <p className="text-slate-400 text-sm ">3 Products</p>
                </div>
                <p className="text-green-500 text-base p-[5px]">Back to list</p>
              </div>
              <div className="flex">
                <div className="w-[312px] h-[280px] bg-white rounded-sm	 border border-neutral-200 flex flex-col pl-[20px] gap-7">
                  <div className="flex pt-[18px]">
                    <p className="text-slate-400 uppercase">Billing Address</p>
                  </div>
                  <div className="flex flex-col ">
                    <div>
                      <p className="font-medium">Dainne Russell</p>
                      <p className="text-slate-400 text-sm leading-[21px]">
                        4140 Parker Rd. Allentown, New Mexico 31134
                      </p>
                    </div>
                    <div className="flex flex-col gap-4 pt-3">
                      <div>
                        <p className="text-slate-400 text-sm uppercase  ">Email</p>
                ...
                <div className="w-[312px] h-[280px] bg-white rounded-sm	 border border-neutral-200"></div>
              </div>
            </div>
            ...
            <div className="p-[15px]  inline-flex justify-between w-[984px] h-[36]">
              ...
              <p>
                <span className="font-medium">$25.00</span>(1 Product)
              </p>
