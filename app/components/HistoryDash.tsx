        ...
        <div className="flex gap-[20px] ">
          ...
          <div className="w-[984px] h-[742px] rounded-[8px] border-[1px] border-slate-300 flex flex-col">
            ...
            <div className="p-[15px]  inline-flex justify-between w-[984px] h-[36]">
              ...
              <p>
                <span className="font-medium">$250.00</span>(4 Products)
              </p>
            ...
            <div className="p-[15px]  inline-flex justify-between w-[984px] h-[36]">
              ...
              <p>
                <span className="font-medium">$35.00</span>(1 Products)
              </p>
            ...
            <div className="p-[15px]  inline-flex justify-between w-[984px] h-[36]">
              ...
              <p>
                <span className="font-medium">$578.00</span>(13 Products)
              </p>
              <p className="font-normal	">Completed</p>
              <p className="text-green-500">View Details</p>
            </div>
            ...
            <div className="p-[15px]  inline-flex justify-between w-[984px] h-[36]">
              ...
              <p className="">1 Feb, 2020</p>
              <p>
                <span className="font-medium">$238.00</span>(13 Products)
              </p>
              <p className="font-normal	">Completed</p>
              <p className="text-green-500">View Details</p>
            </div>
            <div className="p-[15px]  inline-flex justify-between w-[984px] h-[36]">
              ...
              <p className="">1 Feb, 2020</p>
              <p>
                <span className="font-medium">$158.00</span>(13 Products)
              </p>
              <p className="font-normal	">Completed</p>
              <p className="text-green-500">View Details</p>
            </div>
            ...
            <div className="p-[15px]  inline-flex justify-between w-[984px] h-[36]">
              ...
              <p>
                <span className="font-medium">$345.00</span>(5 Products)
              </p>
              <p className="font-normal	">Completed</p>
              <p className="text-green-500">View Details</p>
            </div>
